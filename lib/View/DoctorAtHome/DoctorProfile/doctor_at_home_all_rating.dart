...
class DoctorAtHomeAllRating extends StatefulWidget {
  const DoctorAtHomeAllRating({super.key});

  @override
  State<DoctorAtHomeAllRating> createState() => _DoctorAtHomeAllRatingState();
}

class _DoctorAtHomeAllRatingState extends State<DoctorAtHomeAllRating> {
  @override
