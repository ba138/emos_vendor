...
class LabotryChatWidget extends StatefulWidget {
  const LabotryChatWidget({super.key});

  @override
  State createState() => LabotryChatWidgetState();
}
...
class LabotryChatWidgetState extends State<LabotryChatWidget> {
