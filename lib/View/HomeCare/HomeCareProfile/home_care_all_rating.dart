...
class HomeCareAllRating extends StatefulWidget {
  const HomeCareAllRating({super.key});

  @override
  State<HomeCareAllRating> createState() => _HomeCareAllRatingState();
}

class _HomeCareAllRatingState extends State<HomeCareAllRating> {
  @override
