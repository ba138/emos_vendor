...
class HomeCareHome extends StatefulWidget {
  const HomeCareHome({super.key});

  @override
  State<HomeCareHome> createState() => _HomeCareHomeState();
}

class _HomeCareHomeState extends State<HomeCareHome> {
  bool isOnline = false;
