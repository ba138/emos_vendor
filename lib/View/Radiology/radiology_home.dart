...
import 'package:emos_vendor/View/Radiology/widgets/radiology_widget.dart';
import 'package:emos_vendor/View/Radiology/widgets/top_radiology_widget.dart';
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.pushNamed(
                              context, RouteName.radiologyHistory);
                        },
                        child: Text(
                          'View all',
                          style: GoogleFonts.getFont(
